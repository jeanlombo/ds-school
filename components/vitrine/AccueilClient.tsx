...
import {
  ...
  CheckCircle2, ChevronDown, Clock3, Cloud, CreditCard, FileCheck2, GraduationCap,
...
import type { DonneesDashboardPublic } from "@/lib/vitrine/dashboard-public";
    ...
    <main className="ds-vitrine">
        ...
        <div className="ds-conteneur ds-hero-grille">
          <div className="ds-hero-texte">
            ...
            <div className="ds-hero-actions ds-reveal ds-delai-3">
              ...
              <Link href="/connexion" className="ds-btn ds-btn-demo">Accéder au système <PlayCircle size={20}/></Link>
            </div>
            <div className="ds-preuve ds-reveal ds-delai-4">
              ...
              <p>Aperçu synchronisé avec <strong>les données du système</strong></p>
              <div className="ds-etoiles">★★★★★</div>
            </div>
          </div>

          <div className="ds-scene-dashboard ds-reveal ds-delai-2">
            <DashboardPreview donnees={donnees} />
          </div>
        </div>
      ...
      <section className="ds-cta" id="contact">
        <div className="ds-conteneur ds-cta-contenu ds-reveal">
          ...
          <div className="ds-cta-actions"><a href="mailto:contact@dsschool.com" className="ds-btn ds-btn-principal">Demander une démonstration <ArrowRight size={18}/></a><a href="mailto:contact@dsschool.com" className="ds-btn ds-btn-contact">Nous contacter ☎</a></div>
