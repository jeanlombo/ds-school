...
export default async function Annees({ searchParams }: { searchParams: Promise<{ succes?: string; erreur?: string }> }) {
  ...
  return <AdminShell utilisateur={utilisateur} titre="Années scolaires" description="Ouvrez, activez et clôturez les périodes académiques.">
