...
export default async function Parametres({ searchParams }: { searchParams: Promise<{ succes?: string; erreur?: string }> }) {
  ...
  return <AdminShell utilisateur={utilisateur} titre="Paramètres de l’établissement" description="Configurez l’identité officielle et les coordonnées de votre école.">
      ...
      <section className={styles.panneau}>
        ...
        <form action={enregistrerParametres} className={styles.panneauCorps}>
          <div className={styles.formGrille}>
            ...
            <div className={styles.champ}><label>Code *</label><input name="code" defaultValue={ecole.code} required /></div>
